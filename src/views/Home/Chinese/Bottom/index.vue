<template>
  ...
  <input type = "text" placeholder="请输入上一句" v-model = "value1" />,  <span class = "txt">{{p1}} </span> <button class = "awe" @click = "show('1')">查看答案</button>
 </div>
   <div class="content">
      <div class="tip" v-if = "flag2">
      {{answers[n2]}}, {{p2}}
    </div>
    <input type = "text" placeholder="请输入上一句" v-model = "value2"   /> , <span class = "txt">{{p2}} </span> <button class = "awe"  @click = "show('2')">查看答案</button>
   </div>
   <div class="content">
      <div class="tip" v-if = "flag3">
      {{answers[n3]}}, {{p3}}
    </div>
     <input type = "text" placeholder="请输入上一句" v-model = "value3"  /> , <span class = "txt">{{p3}} </span> <button class = "awe"  @click = "show('3')">查看答案</button>
   </div>
   <div class="content">
...
data(){
  return{
    ...
    value2:"",
    value3:"",
    answers:["荷尽已无擎雨盖","一年好景君须记","远上寒山石径斜",
